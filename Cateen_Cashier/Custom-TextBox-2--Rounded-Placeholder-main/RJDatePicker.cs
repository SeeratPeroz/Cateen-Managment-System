...
namespace CustomControls.RJControls
{
    public class RJDatePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = Cateen_Cashier.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = Cateen_Cashier.Properties.Resources.calendarDark;
                else calendarIcon = Cateen_Cashier.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
